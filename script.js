...
const voltageChart = new Chart(document.getElementById("voltageChart"), {
    ...
    options: {
        scales: {
            ...
            y: {
                min: 0,
                max: 260, // Set y-axis range from 0 to 250
                title: {
                    display: true,
...
const currentChart = new Chart(document.getElementById("currentChart"), {
    ...
    options: {
        scales: {
            ...
            y: {
                min: 0,
                max: 10, // Set y-axis range from 0 to 100
                title: {
                    display: true,
...
const powerChart = new Chart(document.getElementById("powerChart"), {
    ...
    options: {
        scales: {
            ...
            y: {
                min: 0,
                max: 100, // Set y-axis range from 0 to 25
                title: {
                    display: true,
                    text: 'POWER (W)' // Label the y-axis as "POWER"
                }
            }
        }
    }
...
const frequencyChart = new Chart(document.getElementById("frequencyChart"), {
    ...
    options: {
        scales: {
            ...
            y: {
                min: 45,
                max: 65, // Set y-axis range from 0 to 60 Hz
                title: {
                    display: true,
...
const energyChart = new Chart(document.getElementById("energyChart"), {
    ...
    options: {
        scales: {
            ...
            y: {
                min: 0,
                max: 10, // Energy range, can be adjusted based on expected values
                title: {
                    display: true,
                    text: 'Energy (kWh)'
                }
