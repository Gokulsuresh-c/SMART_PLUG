...
const relayApiKey = '2IYKGB5P3MGINZHX'; // Relay Operation API Key
const relayChannelId = '2884632'; // Relay Operation Channel ID

const loadApiKey = 'Z9I8A8CEOFKGXNNN'; // Load Monitoring API Key
const loadChannelId = '2800872'; // Load Monitoring Channel ID
...
async function fetchRelayStatus() {
    const response = await fetch(`https://api.thingspeak.com/channels/${relayChannelId}/feeds.json?api_key=${relayApiKey}&results=1`);
...
async function fetchData() {
    const response = await fetch(`https://api.thingspeak.com/channels/${loadChannelId}/feeds.json?api_key=${loadApiKey}&results=96`);
    const data = await response.json();
